...
npcOperate("Talk-to", "del_monty") {
    npc<CatNeutral>("Hello, no-fur. What are you doing in my mistress's garden?")
    choice {
        option<Neutral>("Looking for sq'irks.") {
            npc<CatNeutral>("If it's sq'irks you're after then you've come to the right place. We've got four seasons' worth of them.")
            player<Neutral>("I've a couple of questions.")
            npc<CatNeutral>("I'd be happy to help a friend of the feline.")
            player<Neutral>("What do you mean?")
            npc<CatNeutral>("The Sphinx gave you that amulet, so she must hold you in high regard.")
            player<Neutral>(" If I remember correctly, it was the High Priest of Sophanem who gave it to me.")
            npc<CatNeutral>("He and the Sphinx are as thick as thieves, but regardless, I think you've a bit of a cat feel about you.")
            npc<CatNeutral>("Now what are these questions?")
            questions()
        }
        option<Neutral>("Talking to cats.") {
            npc<CatNeutral>("A noble and rewarding past-time.")
            choice {
        ...
        option<Neutral>("Nothing much.") {
            npc<CatNeutral>("Yawn! Nice talking to you then, no-fur.")
        }
    }
}
...
suspend fun Interaction<Player>.questions() {
    choice {
        option<Neutral>("What are the creatures inside the gardens?") {
            npc<CatNeutral>("Oh, you mean the gardeners?")
            player<Uncertain>("The strange, floaty creatures.")
            npc<CatNeutral>("Yes, the gardeners. Don't let them see you or they'll teleport you out here. They're very protective of their crops.")
            moreQuestions()
        }
        option<Neutral>("How do you get into the seasonal gardens?") {
            npc<CatNeutral>("I get in through gaps in the hedge. You are a little too big to squeeze through. I think you'll have to use the gates.")
            npc<CatNeutral>("I think the gates are locked, so you'll have to have good Thieving skills to get in.")
            moreQuestions()
        }
        option<Neutral>("How is it that the gardens are in different seasons?") {
            npc<CatNeutral>("How did you get here?")
            player<Uncertain>("Magic?")
            npc<CatNeutral>("Exactly. The Sorceress likes to have a good supply of in-season sq'irks and herbs at all times.")
            moreQuestions()
        }
        option<Neutral>("How do I get out of here?") {
            npc<CatNeutral>("Take a drink from the fountain.")
            moreQuestions()
        }
    }
}
...
suspend fun Interaction<Player>.getHere() {
    npc<CatNeutral>("Every time I play with spiders in the Sorceress's house, her silly apprentice completely freaks out and teleports me here!")
    player<Neutral>("So you've been stuck here since?")
    npc<CatNeutral>("No, silly! I drink from the fountain whenever I want to leave.")
    anotherQuestion()
}
...
suspend fun Interaction<Player>.doingHere() {
    ...
    npc<CatNeutral>("Don't tell me. Osman, right?")
    player<Uncertain>("One of his spies, Selim. You know Osman?")
    npc<CatNeutral>("Oh, he used to come here all the time. Then one day, he just stopped.")
    anotherQuestion()
}

suspend fun Interaction<Player>.whoAreYou() {
    npc<CatNeutral>("Del-Monty the cat, at your service.")
    player<Neutral>("Are you a famous adventurer who was turned into a cat by a vindictive mage?")
    npc<CatNeutral>("No; as I said, I'm Del-Monty the cat, connoisseur of exotic fruits.")
    player<Neutral>("In that case, can you tell me anything about sq'irks?")
    npc<CatNeutral>("But of course! Their juice is an excellent source of energy for runners, and in the riper varieties they are known to heighten one's Thieving abilities.")
    anotherQuestion()
}
